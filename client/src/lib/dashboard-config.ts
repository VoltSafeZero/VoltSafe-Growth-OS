...
export const WIDGET_DEFS: Record<CenterType, WidgetDef[]> = {
  // Phase 4 declutter: trimmed to 6 default-visible widgets that answer
  // "what needs my attention today + where's the money/risk?". All other
  // widgets stay registered and selectable from the Widgets sheet.
  ceo: [
    ...
    { id: "close_opps_score",     label: "Close-Likelihood Deals",   description: "Top opps ranked by close probability",   defaultVisible: false, category: "classic" },
    { id: "churn_score",          label: "Churn Risk Signals",       description: "Accounts most at risk of churning",      defaultVisible: false, category: "classic" },
    ...
    { ...NEW_WIDGETS.my_inbox,               defaultVisible: false },
  ...
  cfo: [
    ...
    { id: "hardware_revenue",     label: "Hardware Revenue",         description: "Contracted vs booked vs delivered",      defaultVisible: false, category: "classic" },
  ...
  cto: [
    ...
    { id: "deployment_risk_score",label: "Deployment Delay Risk",    description: "Sites ranked by AI-predicted delay risk",defaultVisible: false, category: "classic" },
  ...
  sales: [
    { id: "overdue_tasks",        label: "Overdue Tasks",            description: "Tasks past their due date",              defaultVisible: false, category: "classic" },
    { id: "suggested_actions",    label: "Suggested Actions",        description: "AI signals and recommended follow-ups",  defaultVisible: false, category: "classic" },
    { id: "hottest_leads_score",  label: "Hottest Leads",            description: "Top leads ranked by AI quality score",   defaultVisible: true,  category: "classic" },
    ...
    { id: "stale_deals",          label: "Stale Deals",              description: "Opportunities with no recent activity",  defaultVisible: false, category: "classic" },
  ...
  cs: [
    ...
    { id: "churn_risk_score",     label: "Churn Risk",               description: "Accounts most at risk of churning",      defaultVisible: false, category: "classic" },
