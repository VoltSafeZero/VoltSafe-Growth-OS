...
export const WIDGET_DEFS: Record<CenterType, WidgetDef[]> = {
  ceo: [
    ...
    { id: "close_opps_score",     label: "Close-Likelihood Deals",   description: "Top opps ranked by close probability",   defaultVisible: true  },
    { id: "churn_score",          label: "Churn Risk Signals",       description: "Accounts most at risk of churning",      defaultVisible: true  },
    { id: "cert_blockers",        label: "Certification Blockers",   description: "Engineering cert issues blocking deals",  defaultVisible: false },
    { id: "deployment_blockers",  label: "Deployment Blockers",      description: "Installs and rollout blocked",           defaultVisible: false },
  ...
  cfo: [
    ...
    { id: "churn_risk_financial", label: "Churn Risk / Revenue",     description: "Top churn risks with ARR exposure",      defaultVisible: true  },
  ...
  cto: [
    ...
    { id: "deployment_risk_score",label: "Deployment Delay Risk",    description: "Sites ranked by AI-predicted delay risk",defaultVisible: true  },
  ...
  cmo: [
    ...
    { id: "hottest_leads_score",  label: "Hottest Leads",            description: "Top leads ranked by AI quality score",   defaultVisible: true  },
  ...
  sales: [
    ...
    { id: "hottest_leads_score",  label: "Hottest Leads",            description: "Top leads ranked by AI quality score",   defaultVisible: true  },
    { id: "close_opps_score",     label: "Close-Likelihood Deals",   description: "Top opps ranked by AI close probability",defaultVisible: true  },
    { id: "quote_urgency_score",  label: "Quote Follow-up Urgency",  description: "Quotes ranked by AI urgency score",      defaultVisible: true  },
  ...
  cs: [
    ...
    { id: "churn_risk_score",     label: "Churn Risk",               description: "Accounts most at risk of churning",      defaultVisible: true  },
    { id: "expansion_score",      label: "Expansion Ready",          description: "Accounts with high expansion likelihood",defaultVisible: true  },
