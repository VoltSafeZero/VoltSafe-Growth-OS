...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Government & Public Sector", url: "/strategy/partnerships/government-public", icon: Landmark },
      { title: "Channel & Commercial Partners", url: "/strategy/partnerships/channel-commercial", icon: Truck },
      { title: "Technology & Manufacturing", url: "/strategy/partnerships/technology-manufacturing", icon: Zap },
      { title: "Innovation & Research", url: "/strategy/partnerships/innovation-research", icon: FlaskConical },
      { title: "Advisory & Professional Services", url: "/strategy/partnerships/advisory-professional", icon: Briefcase },
      { title: "Media & Ecosystem", url: "/strategy/partnerships/media-ecosystem", icon: Newspaper },
    ],
  },
  {
    id: "execution",
