...
export default function CommunicationsPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight" data-testid="text-page-title">Communications</h1>
        <p className="text-muted-foreground mt-1">Manage broadcast lists and campaign drafts.</p>
      </div>
