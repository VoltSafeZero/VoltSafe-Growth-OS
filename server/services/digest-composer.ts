...
const ROLE_SECTION_DEFAULTS: Record<string, DigestSection[]> = {
  ...
  customer_success: ["renewalRisks", "churnRisks", "overdueTasks", "topPriorities", "hotOpportunities"],
  engineer: ["blockedInstalls", "certBlockers", "overdueTasks", "topPriorities", "procurementBlockers"],
