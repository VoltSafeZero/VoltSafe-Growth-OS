...
export const contacts = pgTable("contacts", {
  ...
  notes: text("notes"),
  avatarUrl: text("avatar_url"),
  // ── CASL / CAN-SPAM compliance (added via migrateComplianceSchema) ─────────
  recipientCountry: text("recipient_country"),
  provinceState: text("province_state"),
  jurisdiction: text("jurisdiction").default("unknown"),
  canadaContact: boolean("canada_contact").default(false),
  usContact: boolean("us_contact").default(false),
  consentStatus: text("consent_status").default("unknown"),
  consentType: text("consent_type"),
  consentSource: text("consent_source"),
  consentTimestamp: timestamp("consent_timestamp"),
  consentCaptureMethod: text("consent_capture_method"),
  consentLanguageVersion: text("consent_language_version"),
  consentLanguageText: text("consent_language_text"),
  consentFormUrl: text("consent_form_url"),
  consentIpAddress: text("consent_ip_address"),
  consentUserAgent: text("consent_user_agent"),
  consentReferrer: text("consent_referrer"),
  relatedBusinessRelationshipType: text("related_business_relationship_type"),
  relatedBusinessRelationshipDate: date("related_business_relationship_date"),
  impliedConsentExpiryDate: date("implied_consent_expiry_date"),
  unsubscribeStatus: text("unsubscribe_status").default("subscribed"),
  unsubscribeTimestamp: timestamp("unsubscribe_timestamp"),
  unsubscribeSource: text("unsubscribe_source"),
  suppressionStatus: text("suppression_status").default("none"),
  suppressionReason: text("suppression_reason"),
  emailValid: boolean("email_valid"),
  leadSource: text("lead_source"),
  leadSourceDetail: text("lead_source_detail"),
  publicBusinessEmailUrl: text("public_business_email_url"),
  eventSource: text("event_source"),
  firstContactReason: text("first_contact_reason"),
...
export const priceListItems = pgTable("price_list_items", {
  ...
  category: text("category").notNull().default("hardware"),
  listPrice: doublePrecision("list_price").default(0),
  unitType: text("unit_type").notNull().default("per unit"),
  isRecurring: boolean("is_recurring").default(false),
  sortOrder: integer("sort_order").default(0),
  // Commercial Engine fields
  industryCode: text("industry_code").default("GEN"),
  industryName: text("industry_name").default("General"),
  commercialType: text("commercial_type").default("hardware"),
  productFamily: text("product_family"),
  powerLevel: text("power_level"),
  pricingModel: text("pricing_model").default("one_time"),
  billingInterval: text("billing_interval"),
  isActive: boolean("is_active").default(true),
  isPrimaryQuoteItem: boolean("is_primary_quote_item").default(false),
  itemCurrency: text("item_currency"),
...
export const marketingCampaigns = pgTable("marketing_campaigns", {
  ...
  notes:             text("notes"),
  // ── CASL / CAN-SPAM compliance (added via migrateComplianceSchema) ─────────
  targetJurisdiction:              text("target_jurisdiction").default("unknown"),
  senderName:                      text("sender_name"),
  senderLegalEntity:               text("sender_legal_entity"),
  fromEmail:                       text("from_email"),
  replyToEmail:                    text("reply_to_email"),
  sendingDomain:                   text("sending_domain"),
  sendingDomainApproved:           boolean("sending_domain_approved").default(false),
  contactEmail:                    text("contact_email"),
  contactPhone:                    text("contact_phone"),
  physicalMailingAddress:          text("physical_mailing_address"),
  previewText:                     text("preview_text"),
  unsubscribeLinkIncluded:         boolean("unsubscribe_link_included").default(true),
  preferenceCenterLinkIncluded:    boolean("preference_center_link_included").default(false),
  commercialDisclosureIncluded:    boolean("commercial_disclosure_included").default(false),
  footerVersion:                   text("footer_version"),
  complianceStatus:                text("compliance_status").default("pending"),
  complianceErrors:                jsonb("compliance_errors"),
  recipientCountBeforePreflight:   integer("recipient_count_before_preflight"),
  recipientCountAfterSuppression:  integer("recipient_count_after_suppression"),
  blockedRecipientCount:           integer("blocked_recipient_count"),
